...
public class UserController {
	...
	public String forgotPassword(@RequestParam String emailId)
	{
		...
		if(existingUser==null)
		{
			...
			ConfirmationOtp otp=otpService.findConfirmationOtpByUser(existingUser.getUserid());
	...
	public String restPassword(@RequestParam Integer otp,@RequestParam String email,@RequestParam String newPassword,@RequestParam String reEnterNewPassword)
	{
		if(otp!=null&&email!=null&&newPassword!=null&&reEnterNewPassword!=null&&newPassword.equals(reEnterNewPassword))
		{
			ConfirmationOtp confirmationOtp=otpService.findConfirmationOtpByOtp(otp);
			if(confirmationOtp!=null)
			{
